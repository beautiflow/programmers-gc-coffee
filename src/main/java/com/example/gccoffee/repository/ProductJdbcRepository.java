...
public class ProductJdbcRepository implements ProductRepository {
    ...
    public Product insert(Product product) {
        ...
        "VALUES(UUID TO BIN(:productId):productName, : category, :price, :description, :createdAt, :updateAt)", toParamMap(product));
        if(update != 1){
    ...
    private static final RowMapper<Product> productRowMapper = (resultSet, i) -> {
        ...
        return new Product(productId, productName, price, description, createdAt, updatedAt);
    };
    ...
    private Map<String, Object> toParamMap(Product product){
        ...
        paramMap.put("createAt",product.getCreatedAt());
        paramMap.put("updateAt",product.getUpdatedAt());
        return paramMap;
        }
